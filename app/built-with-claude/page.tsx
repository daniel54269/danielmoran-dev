    ...
    <Container size="prose" className="py-12 sm:py-20">
      ...
      <div className="prose-custom mt-10">
        ...
        <ul>
          ...
          <li><strong>Headless Chrome</strong> for the résumé PDF pipeline (<code>resume/build.mjs</code>, zero dependencies).</li>
        </ul>

        <h2>On the MCP server</h2>
        <p>
          There are now official marketing-stack MCP servers, including one from HubSpot. I built my own{" "}
        ...
        <p>
          The résumé is generated by a small Node script that prints an HTML template to PDF with headless
          Chrome. Every bullet is tagged by variant, so two résumés (AI Marketing and AI Engineer) ship from
          one content file with <code>npm run resume</code>. Adding a variant is one more tag.
        </p>
