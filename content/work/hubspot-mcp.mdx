...
If you're hiring a Head of Marketing and a candidate hands you an open-source MCP server for a major marketing stack — that's a different conversation than "I use HubSpot daily." It's the same difference as "I've read about React" vs. shipping a React app.
