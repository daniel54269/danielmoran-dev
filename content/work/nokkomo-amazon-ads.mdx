...
Nokkomo Mints is a DTC mints brand selling on Amazon and Shopify. When I joined as co-founder and CMO, the Amazon advertising operation was running at **81% ACOS on sub-scale revenue** &mdash; meaningfully negative unit economics. The account had a single Sponsored Products campaign attempting to do the work of a full structure: broad-match keywords with no negatives, no Sponsored Brands or Sponsored Display coverage, and creative that had not been refreshed in months.
...
I recruited and managed a team of **eight UCLA interns** across three workstreams &mdash; creative production, content operations, and Amazon catalog management &mdash; with rotating role assignments by quarter and weekly review cadences. The intern program also served as a structured pipeline for full-time hiring conversations and provided meaningful early-career experience to the team.

## Outcome

- **ACOS 81% → 38%** in 90 days
- **913% YoY revenue growth** &mdash; trailing revenue indexed 10×
...
This was not an agency engagement. As co-founder I held equity in the outcome and full responsibility for the end-to-end marketing function &mdash; ad architecture, creative, Shopify storefront, and lifecycle email. The results reflect what is possible when an engineer rebuilds an advertising account from first principles, rather than operating within the defaults that a dashboard surfaces.
